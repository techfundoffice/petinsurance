// Generate 1 million static keywords and format as JavaScript array
const fs = require('fs');
...
// Write to file
fs.writeFileSync('million_keywords_array.js', output);
console.log(`Generated ${keywords.length} keywords and saved to million_keywords_array.js`);
console.log(`File size: ${Math.round(fs.statSync('million_keywords_array.js').size / 1024 / 1024)} MB`);
